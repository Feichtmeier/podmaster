...
A podcast desktop player as an example app to showcase the power of [flutter-it](flutter-it.dev)

Disclaimer: the name might change in the future. :blush:

## What is this app about?

Podmaster is a desktop app for listening to podcasts, built with Flutter. It serves as an example application to demonstrate how to use a set of packages (`flutter-it`, `get-it`, `command-it`, `watch-it`, `listen-it`) to build a well-structured Flutter application - without code-generation! :rocket:
